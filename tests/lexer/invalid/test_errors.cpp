...
int main() {
    std::vector<ErrorTestCase> tests = {
        ...
        },
        {
            "Invalid number",
            "int x = 123abc;",
            {"Invalid integer literal", "Invalid number literal"},
            1  // Ожидаем 1 ошибку (а не 2)
        },
        {
            "Unterminated string",
            "string s = \"hello;",
        ...
        },
        {
            ...
            "int x = 2147483648;",
            {"Invalid integer literal", "Integer literal out of range"},
            1  // Ожидаем 1 ошибку
        },
        {
            "Multiple errors",
            ...
            {
                "Unexpected character: '@"  // Только первая ошибка
            },
            1  // Ожидаем только 1 ошибку (первую)
        },
        {
            "Invalid operator",
            "int x = 5 & 3;",
