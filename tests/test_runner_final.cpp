...
int main() {
    ...
    std::vector<TestCase> tests = {
        ...
        // 3. Все ключевые слова
        {
            "All keywords",
            "fn if else while for return int float bool void true false struct const",
            {
                "1:1 KW_FN \"fn\"",
                "1:4 KW_IF \"if\"",
                "1:7 KW_ELSE \"else\"",
                ...
                "1:39 KW_BOOL \"bool\"",
                "1:44 KW_VOID \"void\"",
                "1:49 BOOL_LITERAL \"true\" [true]",
                "1:54 BOOL_LITERAL \"false\" [false]",
                "1:60 KW_STRUCT \"struct\"",
                "1:67 KW_CONST \"const\"",
                "1:72 END_OF_FILE \"\""
            }
        },
        
        // 4. Целые числа (граничные значения)
        {
            ...
            "0 1 42 2147483647 -2147483648",
            {
                ...
                "1:19 MINUS \"-\"",
                "1:20 INT_LITERAL \"2147483648\" [2147483648]",
                "1:31 END_OF_FILE \"\""
            }
        },
        ...
        // 14. Строки с escape-последовательностями
        {
            "String escapes",
            "\"\\n\" \"\\t\" \"\\r\" \"\\\\\" \"\\\"\"",
            {
        ...
        // 19. Вложенные комментарии
        {
            ...
            "/* outer /* inner */ outer */ x = 5",
            {
                "1:34 IDENTIFIER \"x\"",
                "1:36 EQUAL \"=\"",
                "1:38 INT_LITERAL \"5\" [5]",
                "1:39 END_OF_FILE \"\""
            }
        },
        
        // 20. Смешанные пробелы
        {
            "Mixed whitespace",
            "x\t=\n5\r\ny = 10",
            {
